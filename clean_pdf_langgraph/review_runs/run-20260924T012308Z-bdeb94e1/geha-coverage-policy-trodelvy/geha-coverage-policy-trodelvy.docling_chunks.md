...
Headings: Trodelvy (Sacituzumab govitecan-hziy)

Trodelvy (Sacituzumab govitecan-hziy)
Original Effective Date: 10/1/2025
Revision Date(s): 10/1/2025
...
Headings: Unresectable Locally Advanced or Metastatic Breast Cancer

Unresectable Locally Advanced or Metastatic Breast Cancer
- The member is 18 years of age or older; AND
- The member has an ECOG performance status of 0-1 1 ; AND
- The member has HER2 negative (IHC 0, IHC 1+ or IHC 2+/ISH-) and hormone receptor (HR) positive disease; AND
- The member has progressed on prior endocrine and CDK 4/6 inhibitor therapy; AND
- The member has progressed on at least two prior lines of systemic chemotherapy (at least one of these prior lines in the metastatic setting); AND
- The member is not a candidate for fam-trastuzumab deruxtecan-nxki (Enhertu); OR
- The member has triple negative breast cancer; AND
- The member has progressed on or after at least two prior lines of systemic therapy (at least one of these prior lines in the metastatic setting)
...
Limitations
- The treatment of members with urothelial cancer with Trodelvy is not recommended.
...
Billing:
Trodelvy, HCPCS Code = J9317. Trodelvy, Description = Injection, sacituzumab govitecan-hziy, 2.5 mg
...
References
1. [Trodelvy. [package insert]. Gilead Sciences, Inc. Foster City, CA. Available at: https://www.accessdata.fda.gov/drugsatfda_docs/label/2025/761115s059lbl.pdf](https://www.accessdata.fda.gov/drugsatfda_docs/label/2025/761115s059lbl.pdf)
2. Trodelvy. NCCN Drugs & Biologics Compendium. Available at: https://www.nccn.org/professionals/drug_compendium/content/
3. Referenced with permission from the NCCN Clinical Practice Guidelines in Oncology (NCCN Guidelines®). National Comprehensive Cancer Network, Inc. 2025. All rights reserved. Accessed
September 5, 2025. To view the most recent and complete version of the guideline, go online to NCCN.org.
4. Powles, T. et al. Sacituzumab govitecan in advanced urothelial carcinoma: TROPiCS-04, a phase III randomized trial. Annals of Oncology, Volume 36, Issue 5, 561 - 571.
...
10/1/2025, Updates = New med nec policy presented and approved by OH P&T. 10/23/25, Updates = Policy adopted by GEHA; document updated for universal accessibility.
