...
PLANS = ["GEHA Elevate Plus (HDHP)", "GEHA Standard", "GEHA High",
         "GEHA Elevate (HDHP)", "GEHA Medical Benefit (PSHB)"]

# --- Patient / member generator ----------------------------------------------
FIRST = ["James", "Maria", "Robert", "Linda", "Michael", "Susan", "William",
         "Karen", "David", "Nancy", "Richard", "Barbara", "Joseph", "Aisha",
         "Thomas", "Priya", "Charles", "Donna", "Christopher", "Elena",
         "Daniel", "Sandra", "Matthew", "Yusuf", "Anthony", "Grace",
         "Mark", "Hannah", "Donald", "Rachel"]
...
DISEASES = [
    ...
    ("S93.401A", "Sprain of unspecified foot, initial encounter",
    ...
    ("J45.909", "Unspecified asthma, uncomplicated",
     [("99214", "Office visit", 230.00, "11"),
      ("94010", "Spirometry", 95.00, "11")]),
    ...
    ("K08.101", "Partial loss of teeth, unspecified cause, class I",
...
NPIS = ["1982635411", "1674892022", "1325478890", "1452378901", "1098723456",
        "1554981234", "1876543290", "1432569871"]
...
def build_claim(i: int, forced_diag: tuple | None = None) -> dict:
    ...
    city = random.choice(["Arlington", "Silver Spring", "Washington", "Bethesda",
                          "Reston", "Alexandria", "Tysons", "Rockville", "Annandale"])
    state = random.choice(["VA", "MD", "DC", "VA", "MD", "VA"])
    zipc = random.choice(["22041", "20904", "20001", "20814", "20191", "22314",
                          "22182", "20850", "22003"])
    ...
    return {
        ...
        "rendering_provider": {"npi": npi(), "name": random.choice([
            "Dr. A. Bennett", "Dr. S. Chen", "Dr. R. Gupta", "Dr. L. Okafor",
            "Dr. J. Miller", "Dr. T. Alvarez", "Dr. M. Park", "Dr. K. Singh"])},
