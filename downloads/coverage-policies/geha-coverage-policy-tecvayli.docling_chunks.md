...
Multiple Myeloma (MM)
- Tecvayli will be given as monotherapy; AND
- The member is 18 years of age or older; AND
- The member has had no prior treatment with a B cell maturation antigen (BCMA) targeted therapy (e.g. Abecma, Carvykti, Elrexfio); AND
- The member has not had an allogeneic stem cell transplant within the past 6 months; AND
- The member has not had an autologous stem cell transplant within the past 12 weeks; AND
- The member has an Eastern Cooperative Oncology Group (ECOG) score of 0 or 1 1 ; AND
- The member does not have CNS involvement or clinical signs of meningeal involvement of multiple myeloma; AND
- The member's prior therapy includes at least four prior systemic therapies (including a proteasome inhibitor (PI), an immunomodulatory agent (IMiD), and an anti-CD38 monoclonal antibody)
...
Billing
Tecvayli, HCPCS Code = J9380. Tecvayli, Description = Injection, teclistamab-cqyv, 0.5 mg
...
References
1. Tecvayli [package insert]. Janssen Biotech, Inc., Horsham, PA.  Available at: https://www.janssenlabels.com/package-insert/product-monograph/prescribinginformation/TECVAYLI-pi.pdf
2. [Tecvayli. NCCN Drugs and Biologics Compendium. Available at: https://www.nccn.org/professionals/drug_compendium/content/](https://www.nccn.org/professionals/drug_compendium/content/)
...
Disclaimer
Drug Coverage Policies are developed as needed, reviewed and updated at least annually, and are subject to change. Other policies and coverage determination guidelines may apply. Federal and state OncoHealth G.E.H.A
...
1/24/2024, Updates = Policy creation. 4/17/2025, Updates = Annual Review, update to universal criteria. 4/21/2025, Updates = Approved by P&T. 5/12/2025, Updates = Policy adopted by GEHA; document assessed for accessibility
