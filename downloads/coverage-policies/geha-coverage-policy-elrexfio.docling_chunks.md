...
Revision Date(s): 4/1/2024, 9/27/2024; 2/16/2026
Review Date: 2/16/2026
Policy type: Medical Necessity
Line of Business: All G.E.H.A Commercial Medical Plans
...
- Member has received at least four prior therapies and is refractory to at least one proteasome inhibitor (PI), one immunomodulatory agent (IMiD), and one anti-CD38 monoclonal antibody; AND
- Member has an Eastern Cooperative Oncology Group (ECOG) score of 0 to 2¹; AND
- Member has not had a stem cell transplant within 12 weeks; AND
- Member has not experienced disease progression while on a bispecific B-cell maturation antigen (BCMA) – directed CD3 T-cell engager – containing regimen; AND
...
1 ECOG score of 3 will be considered on a case-by-case basis.
...
Billing
Elrexfio, HCPCS Code = J1323. Elrexfio, Description = Injection, elranatamab-bcmm, 1 mg
...
References
1. Elrexfio [package insert].Pfizer Inc., New York, NY. Available at: https://labeling.pfizer.com/ShowLabeling.aspx?id=19669
2. Elrexfio. NCCN Drugs and Biologics Compendium. Available at: https://www.nccn.org/professionals/drug_compendium/content/
3. Referenced with permission from the NCCN Clinical Practice Guidelines in Oncology (NCCN Guidelines®). National Comprehensive Cancer Network, Inc. 2024. All rights reserved. Accessed February 10, 2026. To view the most recent and complete version of the guideline, go online to NCCN.org.
...
10/31/23, !Updates = Policy creation. 12/11/23, !Updates = Added ECOG footnote; Updated references. 4/1/2024, !Updates = HCPCS updated from J9999 to J1323 with updated description. 9/27/2024, !Updates = Annual Review. 6/11/25, !Updates = Policy adopted by GEHA; document reviewed for universal accessibility. 2/16/2026, !Updates = Annual Review OH P&T; added - Member has not experienced disease progression while on a bispecific B-cell maturation antigen (BCMA) - directed CD3 T-cell engager-containing regimen progression on BCMA target; added prescriber information; approved by OH P&T.
